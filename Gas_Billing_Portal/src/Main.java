...
public class Main {
	...
	public static void viewDB() throws Exception{
		...
		Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/BillingDB","root","Vaishnavi@123");
		...
		System.out.println("Sl No"+"\t| Meter No"+"\tCustomer Name"+"\t\tMobile No"+"\tConnection Date"+"\t\tPrevious Reading"+"\tPresent reading"+"\t  Units"+"\t     Latest Bill"+"   Due");
		System.out.println("__________________________________________________________________________________________________________________________________________________________________");
		int i=1;
		...
		System.out.print(" "+i+".\t| "+rs.getInt(1)+"\t\t");
		
		stringprint(rs.getString(2));
		System.out.print("\t"+rs.getLong(3)+"\t"+rs.getString(4)+"\t\t"+rs.getInt(5)+"\t\t\t"+rs.getInt(6)+"\t\t  "+rs.getInt(7)+"\t\t"+rs.getFloat(8)+"\t   "+rs.getFloat(9)+"\n");
		i++;
		}
		System.out.println("__________________________________________________________________________________________________________________________________________________________________");
		con.close();
	...
	public static void stringprint(String s) { 
		char[] Arrname = new char[20];
		for(int z=0;z<20;z++) {
			if(z<s.length())
			Arrname[z]=s.charAt(z);
			else {
				Arrname[z]=' ';
			}
		}
	...
	public static void generatebill() throws Exception{
		...
		System.out.println("This month Bill amount : "+cst1.getFloat(4)+" rs");
		System.out.println("Total Due amount : "+cst1.getFloat(7)+" rs");
	...
	public static void paybill() throws Exception{
		...
		System.out.println("Due after bill pay of "+amount+" is : "+cst1.getFloat(4)+" rs");
		con.close();
		}
		else {
			System.out.println(no+" is Invalid input");
	...
	public static void checkBill() throws Exception {
		...
		case 1:{
			...
			cst.execute();
			System.out.println("Bill amount for Meter No "+no+" is : "+cst.getFloat(2)+" rs"); 
			con.close();
			break;
		...
		case 2: {
			...
			cst.registerOutParameter(2,Types.FLOAT);
			cst.execute();
			System.out.println("Bill amount for Customer Name "+name+" is : "+cst.getFloat(2)+" rs"); 
			con.close();
			break;
		}
		case 3: {
			...
			cst.registerOutParameter(2,Types.FLOAT);
			cst.execute();
			System.out.println("Bill amount for Customer with Mobile No "+mob+" is : "+cst.getFloat(2)+" rs"); 
			con.close();
			break;
		}
		default:
